...
SRC = sources/main.c sources/draw.c sources/error_check.c sources/fractals.c sources/utils.c sources/utils2.c sources/math.c sources/flags.c sources/zoom.c
# Commands
RM = rm -rf
OBJ = $(SRC:.c=.o)
# Defs
